        ...
        <form id="payForm" action="" method="post">
            ...
            <div class="moon-list">
                ...
                <div class="moon-list-item">
                    ...
                    <span class="moon-list-item-text moon-ft-ellipsis moon-ft-black"><input type="radio" id="payType1" name="payType" value="1"/>微信&nbsp;<input type="radio" id="payType2" name="payType" value="2" checked/>支付宝</span>
                </div>
            </div>
